...
EXTERNAL_ENTITY_RELATION_TYPES = [ "interaction",
                                   ...
                                   "drug_phenotype_association",
                                   "drug_side_effect_association",
                                   "drug_indication_association",
                                   "drug_drug_disease_association",
...
VALID_IDENTIFIER_REFERENCE_TYPES = ["unique", "previous", "alias", "cross-reference", "synonym", "short-name", "exact_synonym", "related_synonym", "broad_synonym", "narrow_synonym", "brand", "product"]
