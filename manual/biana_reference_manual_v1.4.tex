...
\begin{tabular}{|p{3cm}|p{10cm}|}
  ...
  Checked version & Release 2016\_11 of 30-Nov-2016 \\ \hline
  Comments & Swiss-prot and TrembL must be inserted as distinct databases. \\ \hline
  Approximate parsing time & Swissprot: Approximately 1h 15 min. Trembl: The growth of Trembl has been so important during the last three years that it takes too much time to parse. It is recommended not to parse Trembl \\
  \hline
\end{tabular}
%\end{center}
...
\begin{tabular}{|p{3cm}|p{10cm}|}
  ...
  Needed files & All xml files in psi25/species/ \\ \hline
  Parser name & intact \\ \hline
  Input-identifier & Path containing the xml files \\ \hline
  Checked version & Version of October 2016\\ \hline
  Comments & \- \\ \hline
  Approximate parsing time & 2 hours 15 minutes\\ 
  \hline
\end{tabular}
%\end{center}
...
\begin{tabular}{|p{3cm}|p{10cm}|}
  ...
  Database Reference & DisGeNET: a discovery platform for the dynamical exploration of human diseases and their genes. Database (2015) : bav028\\ \hline
  ...
  Needed files & Download the files of the links ``7. ALL gene-disease-pmid associations'' and ``8. ALL variant-disease-pmid associations''. Download also the file in \url{ftp://ftp.ncbi.nih.gov/snp/Entrez/eLinks/snp\_genes.gz} \\ \hline
  Parser name & disgenet\\ \hline
  Input-identifier & The path to the folder containing the compressed files \\ \hline
  Checked version & 5.0\\ \hline
  Comments & \\ \hline
  Approximate parsing time & 30 minutes \\ 
  \hline
\end{tabular}
...
\begin{tabular}{|p{3cm}|p{10cm}|}
  ...
  Database Link & \url{ftp://ftp.ncbi.nlm.nih.gov/gene/DATA/gene2ensembl.gz} \\ \hline
  External Entity Types & protein \\ \hline
  External Entity Relation Types & interaction \\ \hline
  Needed files & Download the file gene2ensembl.gz\\ \hline
  Parser name & ncbigene \\ \hline
  Input-identifier & The path to the folder containing the compressed file \\ \hline
  Checked version & 13-Jun-2017\\ \hline
...
\begin{tabular}{|p{3cm}|p{10cm}|}
  ...
  Checked version & v2.0 (06/24/2016) \\ \hline
  Comments &  \\ \hline
...
\begin{tabular}{|p{3cm}|p{10cm}|}
  ...
  Input-identifier & The path to the downloaded file \\ \hline
  Checked version & 06-Feb-2017 \\ \hline
  Comments &  \\ \hline
  Approximate parsing time & Less than a minute \\ 
  \hline
\end{tabular}
