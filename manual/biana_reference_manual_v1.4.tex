...
\begin{tabular}{|p{3cm}|p{10cm}|}
  ...
  Needed files & uniprot\_sprot.dat.gz (SWISS-PROT)\\ \hline
  Parser name & uniprot \\ \hline
  Input-identifier & Files uniprot\_sprot.dat.gz\\ \hline
  Checked version & Release 2020\_01 \\ \hline
  Comments &TrembL is not parsed anymore because it is too big. \\ \hline
  Approximate parsing time & Swissprot: Approximately 35 min\\
  \hline
\end{tabular}
%\end{center}
...
\begin{tabular}{|p{3cm}|p{10cm}|}
  ...
  Checked version & Release 2020\_05 (23-May-2020) \\ \hline
...
\$> python parse_database.py taxonomy --input-identifier=path/
                                      ...
                                      --database-version="Release 2020_05 (23-May-2020)"
\end{SaveVerbatim}
\printcommand{parser_command}
\end{minipage}
...
\begin{tabular}{|p{3cm}|p{10cm}|}
  ...
  Database Link & \url{https://github.com/HUPO-PSI/psi-mi-CV/blob/master/psi-mi.obo} \\ \hline
  ...
  Checked version & 1.2 (April 21, 2020)\\ \hline
  Comments & \- \\ \hline
...
\begin{tabular}{|p{3cm}|p{10cm}|}
  ...
  Checked version & May 2020\\ \hline
  Comments & \- \\ \hline
  Approximate parsing time & Less than a minute\\ 
  \hline
\end{tabular}
...
\begin{tabular}{|p{3cm}|p{10cm}|}
  \hline
  Description & IntAct provides a freely available, open source database system and analysis tools for molecular interaction data. All interactions are derived from literature curation or direct user submissions and are freely available. \\ \hline
  Database Reference & The MIntAct project - IntAct as a common curation platform for 11 molecular interaction databases. Nucl. Acids Res. (1 January 2014) 42  \\ \hline
  Database Link & \url{ftp://ftp.ebi.ac.uk/pub/databases/intact/current/psi25/species/} \\ \hline
  External Entity Types & Protein\\ \hline
  External Entity Relation Types & Interaction\\ \hline
  Needed files & All xml files in psi25/species/. The files can be downloaded using the script ``download\_intact.py'' \\ \hline
  Parser name & intact \\ \hline
  Input-identifier & Path containing the xml files \\ \hline
  Checked version & Version of May 2020\\ \hline
  Comments & \- \\ \hline
  Approximate parsing time & 2 hours\\ 
  \hline
\end{tabular}
%\end{center}
...
Shell Command:\\
\begin{SaveVerbatim}{parser_command}
\$> python parse_database.py intact --input-identifier=FOLDER_WHERE_DATA_IS_SAVED
                                  --biana-dbname="BIANA_DB"
                                  --biana-dbuser="root"
                                  --biana-dbpass="PASSWORD"
                                  --time-control
                                  --database-name="IntAct"
                                  --database-version="Release 2016_10 of 06-Oct-2016"
                                  --default-attribute="intact"
\end{SaveVerbatim}
\printcommand{parser_command}
\end{minipage}
...
\begin{minipage}{\textwidth}
\subsubsection{IntAct Coronavirus}
...
\begin{tabular}{|p{3cm}|p{10cm}|}
  ...
  Description & IntAct provides a freely available, open source database system and analysis tools for molecular interaction data. All interactions are derived from literature curation or direct user submissions and are freely available. \\ \hline
  Database Reference & The MIntAct project - IntAct as a common curation platform for 11 molecular interaction databases. Nucl. Acids Res. (1 January 2014) 42  \\ \hline
  Database Link & \url{https://www.ebi.ac.uk/intact/query/annot:\%22dataset:coronavirus\%22} \\ \hline
  External Entity Types & Protein\\ \hline
  External Entity Relation Types & Interaction\\ \hline
  Needed files & Download the interactions in MI-TAB 2.7\\ \hline
  Parser name & intactcoronavirus \\ \hline
  Input-identifier & Path containing downloaded file \\ \hline
  Checked version & Version of June 2020\\ \hline
  Comments & \- \\ \hline
  Approximate parsing time & Less than a minute\\ 
  \hline
\end{tabular}
...
Shell Command:\\
\begin{SaveVerbatim}{parser_command}
\$> python parse_database.py intactcoronavirus --input-identifier=FILE_WHERE_DATA_IS_SAVED
                                  --biana-dbname="BIANA_DB"
                                  --biana-dbuser="root"
                                  --biana-dbpass="PASSWORD"
                                  --time-control
                                  --database-name="IntAct"
                                  --database-version="Release 2020_06 of 18/06/2020"
                                  --default-attribute="intact"
\end{SaveVerbatim}
\printcommand{parser_command}
\end{minipage}
...
\begin{minipage}{\textwidth}
\subsubsection{IntAct mutations}

%\begin{center}
\begin{tabular}{|p{3cm}|p{10cm}|}
  \hline
  Description & Dataset of mutations in protein-protein interactions and their effect.  \\ \hline
  Database Link & \url{ftp://ftp.ebi.ac.uk/pub/databases/intact/current/various/mutations.tsv} \\ \hline
   & \url{ftp://ftp.ebi.ac.uk/pub/databases/intact/current/various/intact.fasta} \\ \hline
  External Entity Types & Protein\\ \hline
  External Entity Relation Types & Interaction\\ \hline
  Needed files & mutations.tsv and intact.fasta \\ \hline
  Parser name & intact\_mutations \\ \hline
  Input-identifier & Path containing the files \\ \hline
  Checked version & 08-Jun-2017\\ \hline
  Comments & Introduce the two files in the same folder \\ \hline
  Approximate parsing time & ?\\ 
  \hline
\end{tabular}
%\end{center}
...
Shell Command:\\
\begin{SaveVerbatim}{parser_command}
\$> python parse_database.py intact_mutations --input-identifier=/path/to/folder/with/files/
                                  --biana-dbname="BIANA_DB"
                                  --biana-dbuser="root"
                                  --biana-dbpass="PASSWORD"
                                  --time-control
                                  --database-name="intact_mutations"
                                  --database-version="08-Jun-2017"
\end{SaveVerbatim}
\printcommand{parser_command}
\end{minipage}
...
\item BioGrid
  \begin{description}
    ...
    \item[Website:] https://downloads.thebiogrid.org/BioGRID
    ...
    \item[Checked:] for version 3.5.185 (May 2020)
...
\begin{itemize}
  \item Reactome
    ...
    \item[Reference:] Reactome: a database of reactions, pathways and biological processes. Nucleic Acids Res. 2011 Jan; 39: D691-D697
      ...
      \item[Checked:] v72 (March 16, 2020)
      \item[Parsing time:] 15 minutes
    \end{description}
\end{itemize}
\end{minipage}
...
\begin{tabular}{|p{3cm}|p{10cm}|}
  ...
  Database Link & \url{ftp://ftp.geneontology.org/go/ontology/gene\_ontology\_edit.obo} \\ \hline
  ...
  Checked version & September 20, 2018\\ \hline
...
\begin{tabular}{|p{3cm}|p{10cm}|}
  ...
  Checked version & 5.1.6 (2020-04-22)\\ \hline
...
\$> python parse_database.py drugbank --input-identifier="full_database.xml"
                                    ...
                                    --database-version="5.1.6 (2020-04-22)"
\end{SaveVerbatim}
\printcommand{parser_command}
\end{minipage}
...
Shell Command:\\
\begin{SaveVerbatim}{parser_command}
\$> python parse_database.py dcdb --input-identifier="/path/to/DCDB2_plaintxt/"
                                    --biana-dbname="BIANA_DB"
                                    --biana-dbuser="root"
                                    --biana-dbpass="PASSWORD"
                                    --time-control
...
\begin{tabular}{|p{3cm}|p{10cm}|}
  \hline
  Description & The DisGeNET database integrates human gene-disease associations (GDAs) from various expert curated databases and text-mining derived associations including Mendelian, complex and environmental diseases.\\ \hline
  Database Reference &The DisGeNET knowledge platform for disease genomics: 2019 update. (2019) Nucleic Acid Res\\ \hline
  Database Link & \url{http://www.disgenet.org/web/DisGeNET/menu/downloads} \\ \hline
  External Entity Types & protein, SNP, disease \\ \hline
  External Entity Relation Types & gene\_disease\_association, SNP\_disease\_association, gene\_SNP\_association \\ \hline
  Needed files & Download the files of the links ``ALL gene-disease-pmid associations'', ``ALL variant-disease-pmid associations'', ``Variant-Gene Mappings File'' and ``UMLS CUI to several disease vocabularies''. \\ \hline
  Parser name & disgenet\\ \hline
  Input-identifier & The path to the folder containing the compressed files \\ \hline
  Checked version & 7.0\\ \hline
  Comments & \\ \hline
  Approximate parsing time & 13 minutes \\ 
  \hline
\end{tabular}
%\end{center}
...
Shell Command:\\
\begin{SaveVerbatim}{parser_command}
\$> python parse_database.py disgenet --input-identifier="/path/to/folder/with/files/"
                                    --biana-dbname="BIANA_DB"
                                    --biana-dbuser="root"
                                    --biana-dbpass="PASSWORD"
                                    --time-control
                                    --database-name="DisGeNET"
...
\begin{minipage}{\textwidth}
\subsubsection{NCBI Gene}

%\begin{center}
\begin{tabular}{|p{3cm}|p{10cm}|}
  \hline
  Description & Gene integrates information from a wide range of species. A record may include nomenclature, Reference Sequences (RefSeqs), maps, pathways, variations, phenotypes, and links to genome-, phenotype-, and locus-specific resources worldwide.\\ \hline
  Database Reference & Entrez Gene: gene-centered information at NCBI. (2005) Nucleic Acids Res\\ \hline
  Database Link & \url{ftp://ftp.ncbi.nlm.nih.gov/gene/DATA} \\ \hline
  External Entity Types & protein \\ \hline
  External Entity Relation Types & \\ \hline
  Needed files & Download the files gene2ensembl.gz and gene2go.gz\\ \hline
  Parser name & ncbigene \\ \hline
  Input-identifier & The path to the folder containing the compressed files \\ \hline
  Checked version & 10-Jul-2019\\ \hline
  Comments & The database file must be compressed!! \\ \hline
  Approximate parsing time & 45 minutes \\ 
  \hline
\end{tabular}
%\end{center}
...
Shell Command:\\
\begin{SaveVerbatim}{parser_command}
\$> python parse_database.py ncbigene --input-identifier="/path/to/folder/with/file/"
                                    --biana-dbname="BIANA_DB"
                                    --biana-dbuser="root"
                                    --biana-dbpass="PASSWORD"
                                    --time-control
                                    --database-name="NCBIGene"
                                    --database-version="10-Jul-2019"
\end{SaveVerbatim}
\printcommand{parser_command}
\end{minipage}
...
\begin{minipage}{\textwidth}
\subsubsection{HIPPIE}

%\begin{center}
\begin{tabular}{|p{3cm}|p{10cm}|}
  \hline
  Description & HIPPIE (the Human Integrated Protein Protein Interaction Reference) provides confidence scored and functionally annotated human protein-protein interactions (PPIs) \\ \hline
  Database Reference & HIPPIE v2.0: enhancing meaningfulness and reliability of protein?protein interaction networks. (2017) Nucleic Acids Res\\ \hline
  Database Link & \url{http://cbdm-01.zdv.uni-mainz.de/~mschaefer/hippie/download.php} \\ \hline
  External Entity Types & protein \\ \hline
  External Entity Relation Types & interaction \\ \hline
  Needed files & Download the current release file in PSI-MI TAB 2.5 format \\ \hline
  Parser name & hippie \\ \hline
  Input-identifier & The path to the downloaded file \\ \hline
  Checked version & v2.2 (02/14/19) \\ \hline
  Comments &  \\ \hline
  Approximate parsing time & 3 minutes \\ 
  \hline
\end{tabular}
%\end{center}
...
Shell Command:\\
\begin{SaveVerbatim}{parser_command}
\$> python parse_database.py hippie --input-identifier="/path/to/HIPPIE-current.mitab.txt"
                                    --biana-dbname="BIANA_DB"
                                    --biana-dbuser="root"
                                    --biana-dbpass="PASSWORD"
                                    --time-control
                                    --database-name="hippie"
                                    --database-version="v2.0 (06/24/2016)"
\end{SaveVerbatim}
\printcommand{parser_command}
\end{minipage}
...
\begin{minipage}{\textwidth}
\subsubsection{ConsensusPathDB}

%\begin{center}
\begin{tabular}{|p{3cm}|p{10cm}|}
  \hline
  Description & ConsensusPathDB integrates interaction networks in Homo sapiens including binary and complex protein-protein, genetic, metabolic, signaling, gene regulatory and drug-target interactions, as well as biochemical pathways. \\ \hline
  Database Reference & The ConsensusPathDB interaction database: 2013 update. (2013) Nucleic Acids Res.\\ \hline
  Database Link & \url{http://cpdb.molgen.mpg.de/} \\ \hline
  External Entity Types & protein \\ \hline
  External Entity Relation Types & interaction \\ \hline
  Needed files & ``ConsensusPathDB\_human\_PPI.gz'', ``ConsensusPathDB\_mouse\_PPI.gz'', ``ConsensusPathDB\_yeast\_PPI.gz'' \\ \hline
  Parser name & consensuspathdb \\ \hline
  Input-identifier & Path to the folder containing the uncompressed files \\ \hline
  Checked version & Release 34 (15.01.2019) (human), Release SC10 (01.01.2019) (yeast), Release MM10 (01.01.2019) \\ \hline
  Comments &  \\ \hline
  Approximate parsing time & 5 minutes \\ 
  \hline
\end{tabular}
%\end{center}
...
Shell Command:\\
\begin{SaveVerbatim}{parser_command}
\$> python parse_database.py consensuspathdb --input-identifier="/path/to/folder"
                                    --biana-dbname="BIANA_DB"
                                    --biana-dbuser="root"
                                    --biana-dbpass="PASSWORD"
                                    --time-control
                                    --database-name="consensuspathdb"
                                    --database-version="Release 34, SC10, MM10"
\end{SaveVerbatim}
\printcommand{parser_command}
\end{minipage}
...
\begin{minipage}{\textwidth}
\subsubsection{Interologous Interaction Database (I2D)}

%\begin{center}
\begin{tabular}{|p{3cm}|p{10cm}|}
  \hline
  Description & I2D (Interologous Interaction Database) is an on-line database of known and predicted mammalian and eukaryotic protein-protein interactions. \\ \hline
  Database Reference & Unequal evolutionary conservation of human protein interactions in interologous networks.(2007) Genome Biology\\ \hline
  Database Link & \url{http://ophid.utoronto.ca/ophidv2.204/downloads.jsp} \\ \hline
  External Entity Types & protein \\ \hline
  External Entity Relation Types & interaction \\ \hline
  Needed files & Download the tab-separated files for HUMAN, MOUSE, RAT, FLY, WORM, YEAST and HHV8 \\ \hline
  Parser name & i2d \\ \hline
  Input-identifier & Path to the folder containing the uncompressed files \\ \hline
  Checked version & 2.9 \\ \hline
  Comments &  \\ \hline
  Approximate parsing time & 10 minutes \\ 
  \hline
\end{tabular}
...
Shell Command:\\
\begin{SaveVerbatim}{parser_command}
\$> python parse_database.py i2d --input-identifier="/path/to/folder"
                                    --biana-dbname="BIANA_DB"
                                    --biana-dbuser="root"
                                    --biana-dbpass="PASSWORD"
                                    --time-control
...
\begin{minipage}{\textwidth}
\subsubsection{GPCR dataset}

%\begin{center}
\begin{tabular}{|p{3cm}|p{10cm}|}
  \hline
  Description & GPCR interactome from the publication: Systematic protein-protein interaction mapping for clinically relevant human GPCRs \\ \hline
  Database Reference & Systematic protein-protein interaction mapping for clinically relevant human GPCRs. (2017) Molecular Systems Biology\\ \hline
  Database Link & \url{http://ophid.utoronto.ca/iid/SearchPPIs/dataset/IID-003170131} \\ \hline
  External Entity Types & protein \\ \hline
  External Entity Relation Types & interaction \\ \hline
  Needed files & Download the file clicking at Download results: IID\_Sokolina\_MSB\_2017.txt \\ \hline
  Parser name & gpcr \\ \hline
  Input-identifier & The path to the downloaded file \\ \hline
  Checked version & 1-Apr-2017 \\ \hline
  Comments &  \\ \hline
  Approximate parsing time & Less than a minute \\ 
  \hline
\end{tabular}
...
Shell Command:\\
\begin{SaveVerbatim}{parser_command}
\$> python parse_database.py gpcr --input-identifier="/path/to/IID_Sokolina_MSB_2017.txt"
                                    --biana-dbname="BIANA_DB"
                                    --biana-dbuser="root"
                                    --biana-dbpass="PASSWORD"
                                    --time-control
                                    --database-name="gpcr"
                                    --database-version="1-Apr-2017"
\end{SaveVerbatim}
\printcommand{parser_command}
\end{minipage}
...
\begin{minipage}{\textwidth}
\subsubsection{BRENDA Tissue Ontology (BTO)}

%\begin{center}
\begin{tabular}{|p{3cm}|p{10cm}|}
  \hline
  Description & A structured controlled vocabulary for the source of an enzyme. It comprises terms for tissues, cell lines, cell types and cell cultures from uni- and multicellular organisms. \\ \hline
  Database Reference & The BRENDA Tissue Ontology (BTO): the first all-integrating ontology of all organisms for enzyme sources. (2011) Nucleic Acids Res\\ \hline
  Database Link & \url{https://bioportal.bioontology.org/ontologies/BTO} \\ \hline
  External Entity Types & ontology \\ \hline
  External Entity Relation Types & \\ \hline
  Needed files & BrendaTissue.obo (Download it at Submissions, the most current version in OBO format) \\ \hline
  Parser name & brenda\_tissue\_obo \\ \hline
  Input-identifier & The path to the downloaded file \\ \hline
  Checked version & 03:05:2016 \\ \hline
  Comments &  \\ \hline
  Approximate parsing time & Less than a minute \\ 
  \hline
\end{tabular}
...
Shell Command:\\
\begin{SaveVerbatim}{parser_command}
\$> python parse_database.py brenda_tissue_obo --input-identifier="/path/to/BrendaTissue.obo"
                                    --biana-dbname="BIANA_DB"
                                    --biana-dbuser="root"
                                    --biana-dbpass="PASSWORD"
                                    --time-control
                                    --database-name="BTO"
                                    --database-version="03:05:2016"
\end{SaveVerbatim}
\printcommand{parser_command}
\end{minipage}
...
\begin{minipage}{\textwidth}
\subsubsection{Anatomical Therapeutic Chemical (ATC) classification}
...
\begin{tabular}{|p{3cm}|p{10cm}|}
  ...
  Database Reference &  \\ \hline
  Database Link & \url{https://bioportal.bioontology.org/ontologies/ATC} \\ \hline
  External Entity Types & ontology \\ \hline
  External Entity Relation Types & \\ \hline
  Needed files & ATC.csv (Download it at Submissions, the most current version in CSV format) \\ \hline
  Parser name & atc \\ \hline
  Input-identifier & The path to the downloaded file \\ \hline
  Checked version & 2019AB (18-Nov-2019) \\ \hline
  Comments &  \\ \hline
  Approximate parsing time & Less than a minute \\ 
  \hline
\end{tabular}
...
Shell Command:\\
\begin{SaveVerbatim}{parser_command}
\$> python parse_database.py atc --input-identifier="/path/to/ATC.csv"
                                    --biana-dbname="BIANA_DB"
                                    --biana-dbuser="root"
                                    --biana-dbpass="PASSWORD"
                                    --time-control
                                    --database-name="ATC"
                                    --database-version="2019AB (18-Nov-2019)"
\end{SaveVerbatim}
\printcommand{parser_command}
\end{minipage}
...
\begin{minipage}{\textwidth}
\subsubsection{Human Protein Atlas}

%\begin{center}
\begin{tabular}{|p{3cm}|p{10cm}|}
  \hline
  Description & The "Human Tissue Proteomes" chapters provide a knowledge-based analysis and entry into the Human Protein Atlas from different defined transections of the human tissue proteome. Each separate chapter includes a basic description of a defined proteome and includes analyses of expression patterns, gene lists, and examples of protein expression on a cellular level. \\ \hline
  Database Reference & Proteomics. Tissue-based map of the human proteome. (2015) Science\\ \hline
  Database Link & \url{http://www.proteinatlas.org/about/download} \\ \hline
  External Entity Types & protein, tissue \\ \hline
  External Entity Relation Types & gene\_tissue\_association \\ \hline
  Needed files & normal\_tissue.csv (1. Normal tissue data) and rna\_tissue.csv (4. RNA gene data) \\ \hline
  Parser name & humanproteinatlas \\ \hline
  Input-identifier & Path to the folder containing the uncompressed files\\ \hline
  Checked version & 16.1 \\ \hline
  Comments & Uncompress the files! \\ \hline
  Approximate parsing time & 10 minutes \\ 
  \hline
\end{tabular}
%\end{center}
...
Shell Command:\\
\begin{SaveVerbatim}{parser_command}
\$> python parse_database.py humanproteinatlas --input-identifier="/path/to/folder/with/files/"
                                    --biana-dbname="BIANA_DB"
                                    --biana-dbuser="root"
                                    --biana-dbpass="PASSWORD"
                                    --time-control
                                    --database-name="humanproteinatlas"
...
\begin{minipage}{\textwidth}
\subsubsection{TISSUES (Jensen Lab)}

%\begin{center}
\begin{tabular}{|p{3cm}|p{10cm}|}
  \hline
  Description & TISSUES is a frequently updated web resource that integrates evidence on tissue expression from manually curated literature, proteomics and transcriptomics screens, and automatic text mining. We map all evidence to common protein identifiers and Brenda Tissue Ontology terms, and further unify it by assigning confidence scores that facilitate comparison of the different types and sources of evidence. \\ \hline
  Database Reference & Comprehensive comparison of large-scale tissue expression datasets. (2015) PeerJ\\ \hline
  Database Link & \url{http://tissues.jensenlab.org/Downloads} \\ \hline
  External Entity Types & protein, tissue \\ \hline
  External Entity Relation Types & gene\_tissue\_association \\ \hline
  Needed files & All the human files \\ \hline
  Parser name & tissues \\ \hline
  Input-identifier & Path to the folder containing the files\\ \hline
  Checked version & 3-Apr-2017 \\ \hline
  Comments & \\ \hline
  Approximate parsing time & 30 minutes \\ 
  \hline
\end{tabular}
...
Shell Command:\\
\begin{SaveVerbatim}{parser_command}
\$> python parse_database.py tissues --input-identifier="/path/to/folder/with/files/"
                                    --biana-dbname="BIANA_DB"
                                    --biana-dbuser="root"
                                    --biana-dbpass="PASSWORD"
                                    --time-control
                                    --database-name="tissues"
                                    --database-version="3-Apr-2017"
\end{SaveVerbatim}
\printcommand{parser_command}
\end{minipage}
...
\begin{tabular}{|p{3cm}|p{10cm}|}
  \hline
  Description & DGIdb offers user-friendly browsing, searching, and filtering of information on drug-gene interactions and the druggable genome, mined from over thirty trusted sources. \\ \hline
  Database Reference & DGIdb: mining the druggable genome. (2013) Nature Methods\\ \hline
  Database Link & \url{http://www.dgidb.org/downloads} \\ \hline
  External Entity Types & protein, drug \\ \hline
  External Entity Relation Types & interaction \\ \hline
  Needed files & The interactions.tsv file in the Downloads section \\ \hline
  Parser name & dgidb \\ \hline
  Input-identifier & Path to the file interactions.tsv\\ \hline
  Checked version & 3.0.2 (2018-01-25) \\ \hline
  Comments & \\ \hline
  Approximate parsing time & Less than a minute \\ 
  \hline
\end{tabular}
...
Shell Command:\\
\begin{SaveVerbatim}{parser_command}
\$> python parse_database.py dgidb --input-identifier="/path/to/interactions.tsv"
                                    --biana-dbname="BIANA_DB"
                                    --biana-dbuser="root"
                                    --biana-dbpass="PASSWORD"
                                    --time-control
...
\begin{tabular}{|p{3cm}|p{10cm}|}
  \hline
  Description & ChEMBL is a manually curated database of bioactive molecules with drug-like properties.\\ \hline
  Database Reference & ChEMBL: towards direct deposition of bioassay data. (2019) Nucleic Acid Res.\\ \hline
  Database Link & \url{https://www.ebi.ac.uk/chembl/} \\ \hline
  External Entity Types & protein, drug \\ \hline
  External Entity Relation Types & interaction, drug\_indication\_association \\ \hline
  Needed files & Targets, Drugs, Mechanisms of Action, Drug Indications \\ \hline
  Parser name & chembl \\ \hline
  Input-identifier & Path to the folder with the uncompressed files\\ \hline
  Checked version & ChEMBL\_27\\ \hline
  Comments & \\ \hline
  Approximate parsing time & Less than a minute \\ 
  \hline
\end{tabular}
...
Shell Command:\\
\begin{SaveVerbatim}{parser_command}
\$> python parse_database.py chembl --input-identifier="/path/to/folder"
                                    --biana-dbname="BIANA_DB"
                                    --biana-dbuser="root"
                                    --biana-dbpass="PASSWORD"
                                    --time-control
                                    --database-name="ChEMBL"
                                    --database-version="ChEMBL\_27"
\end{SaveVerbatim}
\printcommand{parser_command}
\end{minipage}
...
\begin{minipage}{\textwidth}
\subsubsection{DrugCentral}

%\begin{center}
\begin{tabular}{|p{3cm}|p{10cm}|}
  \hline
  Description & DrugCentral is comprehensive drug information resource for FDA drugs and drugs approved outside US. The resources can be searched using: drug, target, disease, pharmacologic action, terms. Full text on FDA drug labels is performed when no match for terms above is found. Regulatory approval dates are indicated where available, records with no regulatory information contain old drugs listed for human use outside USA, this list is currently undergoing validation and should be treated as not definitive. \\ \hline
  Database Reference & DrugCentral: online drug compendium. (2017) Nucleic Acids Res.\\ \hline
  Database Link & \url{http://drugcentral.org/download} \\ \hline
  External Entity Types & protein, drug \\ \hline
  External Entity Relation Types & interaction \\ \hline
  Needed files & The Drug-target interaction data and the SMILES and InChI file. Additionally, the user can parse DrugBank before and obtain the drugbank identifiers file by running the script ``parse\_drugbank\_names.py'' \\ \hline
  Parser name & DrugCentral \\ \hline
  Input-identifier & Path to the folder containing the files\\ \hline
  Checked version & 8/26/2018 \\ \hline
  Comments & \\ \hline
  Approximate parsing time & Less than a minute \\ 
  \hline
\end{tabular}
...
Shell Command:\\
\begin{SaveVerbatim}{parser_command}
\$> python parse_database.py DrugCentral --input-identifier="/path/to/interactions.tsv"
                                    --biana-dbname="BIANA_DB"
                                    --biana-dbuser="root"
                                    --biana-dbpass="PASSWORD"
                                    --time-control
                                    --database-name="DrugCentral"
                                    --database-version="8/26/2018"
\end{SaveVerbatim}
\printcommand{parser_command}
\end{minipage}
...
\begin{minipage}{\textwidth}
\subsubsection{Therapeutic Target Database (TTD)}

%\begin{center}
\begin{tabular}{|p{3cm}|p{10cm}|}
  \hline
  Description & TTD is a repository of therapeutic targets of drugs.\\ \hline
  Database Reference & Therapeutic Target Database 2020: enriched resource for facilitating research and early development of targeted therapeutics. (2020) Nucleic Acid Res.\\ \hline
  Database Link & \url{http://db.idrblab.net/ttd/full-data-download/} \\ \hline
  External Entity Types & protein, drug \\ \hline
  External Entity Relation Types & interaction, drug\_indication\_association \\ \hline
  Needed files & TTD targets, TTD cross-matching, Drug synonyms, Drug disease \\ \hline
  Parser name & TTD \\ \hline
  Input-identifier & Path to the folder with the uncompressed files\\ \hline
  Checked version & 14-Jul-2019\\ \hline
  Comments & \\ \hline
  Approximate parsing time & Less than a minute \\ 
  \hline
\end{tabular}
...
Shell Command:\\
\begin{SaveVerbatim}{parser_command}
\$> python parse_database.py TTD --input-identifier="/path/to/folder"
                                    --biana-dbname="BIANA_DB"
                                    --biana-dbuser="root"
                                    --biana-dbpass="PASSWORD"
                                    --time-control
                                    --database-name="TTD"
                                    --database-version="14-Jul-2019"
\end{SaveVerbatim}
\printcommand{parser_command}
\end{minipage}
