...
\begin{tabular}{|p{3cm}|p{10cm}|}
  ...
  Needed files & Download the files of the links ``3. ALL gene-disease associations'' and ``5. All SNP-gene-disease associations'' and uncompress them\\ \hline
  Parser name & disgenet\\ \hline
  Input-identifier & The path to the folder containing the uncompressed files \\ \hline
  Checked version & October of 2016\\ \hline
  Comments & The database files must be uncompressed!! \\ \hline
...
Shell Command:
\begin{SaveVerbatim}{parser_command}
\$> python parse_database.py drugbank --input-identifier="/path/to/folder/with/files/"
                                    --biana-dbname="BIANA_DB"
                                    --biana-dbuser="root"
                                    --biana-dbpass="PASSWORD"
                                    --time-control
                                    --database-name="DisGeNET"
                                    --database-version="October_2016"
\end{SaveVerbatim}
\printcommand{parser_command}
\end{minipage}
