...
\begin{tabular}{|p{3cm}|p{10cm}|}
  ...
  External Entity Types & gene, SNP, disease \\ \hline
  External Entity Relation Types & gene\_disease\_association, SNP\_disease\_association \\ \hline
  Needed files & Download the files of the links ``3. ALL gene-disease-pmid associations'' and ``3. ALL variant-disease-pmid associations'' and uncompress them. Download also the file in \url{ftp://ftp.ncbi.nih.gov/snp/Entrez/eLinks/snp\_genes.gz} \\ \hline
  Parser name & disgenet\\ \hline
  Input-identifier & The path to the folder containing the compressed files \\ \hline
  Checked version & October of 2016\\ \hline
  Comments & \\ \hline
  Approximate parsing time & ? minutes \\ 
  \hline
\end{tabular}
%\end{center}
...
\textcolor{red}{[NOTE:] The parser of DisGeNET is currently being updated and it is not yet available} 
